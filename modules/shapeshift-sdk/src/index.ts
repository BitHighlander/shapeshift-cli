...
module.exports = class wallet {
    ...
    constructor(type:HDWALLETS,config:Config,isTestnet?:boolean) {
        ...
        this.buildTx = async function (transaction: Transaction) {
            let tag = TAG + " | buildTx | "
            try {
                if(!transaction.blockchain) throw Error("invalid transaction")
                if(!transaction.addressTo) throw Error("invalid transaction")
                ...
                switch(transaction.blockchain) {
                    case ChainTypes.Bitcoin:
                        ...
                        const txInput = {
                            ...
                            value: nativeToBaseAmount('BTC',transaction.amount),
